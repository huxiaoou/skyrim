...
class CManagerSignalBase(object):
    def __init__(self, t_mother_universe: list, t_available_universe_dir: str,
        ...
        # available universe lib
        self.m_available_universe_dir: str = t_available_universe_dir
        self.m_available_universe_lib_structure = t_database_structure["available_universe"]
        ...
        self.m_factor_lib_structure = t_database_structure[t_factor_lbl]
    ...
    def close_libs(self):
        self.m_available_universe_lib.close()
        self.m_factor_lib.close()
        return 0
